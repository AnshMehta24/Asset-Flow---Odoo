...
import { transition } from "@/components/event-calendar/animations";
import { EventListDialog } from "@/components/event-calendar/events-list-dialog";
import { DroppableArea } from "@/components/event-calendar/droppable-area";
import { getMonthCellEvents } from "@/components/event-calendar/helpers";
import { useMediaQuery } from "@/components/event-calendar/hooks";
import type { ICalendarCell } from "@/components/event-calendar/interfaces";
import type { IBookingEvent as IEvent } from "@/app/(with-auth)/resource-booking/_schema/booking-schema";
import { EventBullet } from "@/components/event-calendar/event-bullet";
import { MonthEventBadge } from "@/components/event-calendar/month-event-badge";
