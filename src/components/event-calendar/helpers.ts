...
import type {
	ICalendarCell,
	IEvent,
} from "@/components/event-calendar/interfaces";
import type {
	TCalendarView,
	TEventColor,
...
export function groupEvents<T extends IEvent>(dayEvents: T[]): T[][] {
...
export function getMonthCellEvents<T extends IEvent>(
	date: Date,
	events: T[],
...
export const getEventsForDay = <T extends IEvent>(
	events: T[],
	date: Date,
	isWeek = false,
) => {
...
export const getEventsForWeek = <T extends IEvent>(events: T[], date: Date): T[] => {
...
export const getEventsForMonth = <T extends IEvent>(events: T[], date: Date): T[] => {
...
export const getEventsForYear = <T extends IEvent>(events: T[], date: Date): T[] => {
...
export const useGetEventsByMode = <T extends IEvent>(events: T[]) => {
