...
import { DayPicker } from "@/components/event-calendar/day-picker";
...
import { groupEvents } from "@/components/event-calendar/helpers";
import type { IBookingEvent as IEvent } from "@/app/(with-auth)/resource-booking/_schema/booking-schema";
import { CalendarTimeline } from "@/components/event-calendar/calendar-time-line";
import { DayViewMultiDayEventsRow } from "@/components/event-calendar/day-view-multi-day-events-row";
import { RenderGroupedEvents } from "@/components/event-calendar/render-grouped-events";
